$(document).ready(function() {
  ...
  var INDEX_NAME = 'imareal';
  var PARAMS = {
    hitsPerPage: 20,
    maxValuesPerFacet: 12,
    facets: ['institution'],
    // with checkbox
    disjunctiveFacets: ['objekt', 'objektgruppe', 'staat', 'bildthema', 'material-technik', 'ante', 'post']
  };
  var FACETS_SLIDER = ['ante', 'post'];
  var FACETS_ORDER_OF_DISPLAY = ['ante', 'post', 'bildthema', 'objekt', 'objektgruppe', 'material-technik', 'staat', 'institution'];
  var FACETS_LABELS = {bildthema: 'Thema', objekt: 'Objekt', objektgruppe: 'Gruppe', staat: 'Land', institution: 'Institution', ante: 'Ante', post: 'Post'};
