...
*/
  ...
  var PARAMS = {
    ...
    maxValuesPerFacet: 8,
    facets: ['person'],
    disjunctiveFacets: ['zeit', 'material', 'inhalt', 'objekt', 'invnr']
  };
  var FACETS_SLIDER = ['zeit'];
  var FACETS_ORDER_OF_DISPLAY = [ 'zeit', 'material', 'inhalt', 'objekt', 'person', 'invnr'];
  var FACETS_LABELS = {Material: 'material', Inhalt: 'inhalt', Objekt: 'objekt', Personen: 'person', Zeit: 'zeit', Inventar: 'invnr'};
